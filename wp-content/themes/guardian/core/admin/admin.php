...
if (!function_exists('guardian_info_page')) {
	...
	$page1=add_theme_page(__('Welcome to Guardian', 'weblizar'), __('Theme Info', 'weblizar'), 'edit_theme_options', 'guardian', 'guardian_theme_info_page');
...
function weblizar_admin_info(){
	...
	wp_enqueue_script( 'snowfall', get_template_directory_uri() . '/snowfall/snowfall.min.jquery.js', array('jquery') );
		...
		<div class="theme-info-wrap">
			...
			<div class="theme-links clearfix">
				<p><strong><?php _e('Important Links:', 'weblizar'); ?></strong>
					...
					<a href="https://wordpress.org/support/theme/guardian" target="_blank"><?php _e('Support Center', 'weblizar'); ?></a>
					<a href="https://wordpress.org/support/view/theme-reviews/guardian?filter=5" target="_blank"><?php _e('Rate this theme', 'weblizar'); ?></a>
				</p>
			</div>
			<hr>
				...
				<div class="row clearfix">
					<div class="col-1-2">
						...
						<div class="section">
							...
							<p>
								<a href="https://weblizar.com/themes/guardian-premium-theme/" target="_blank" class="button button-secondary"><?php _e('Learn more about the Premium Version', 'weblizar'); ?></a>
							</p>
						</div>
					</div>
					<div class="col-1-2">
			...
			<div id="theme-author">
				<p><?php printf(__('%1s is proudly brought to you by %2s. If you like this WordPress theme, %3s.', 'weblizar'),
					$theme_data->Name,
					'<a target="_blank" href="https://weblizar.com/" title="guardian">Weblizar</a>',
					'<a target="_blank" href="https://wordpress.org/support/view/theme-reviews/guardian?filter=5" title="guardian Review">' . __('rate it', 'weblizar') . '</a>'); ?>
				</p>
			</div>
		</div>
		<div class="xmas-banner">
		<img class="xmas-img" src="<?php echo get_template_directory_uri(); ?>/images/banner.png" alt="xmas-banner">
		</div>
		<?php
	}
}
