...
<?php else: ?>
	...
	<?php
		...
		3 => array(
			'section_title'	=> 'A message from our management team',
			'menutitle'		=> '',
			'bgcolor' 		=> '#ffffff',
			'menutitle'		=> '',
			'bgimage'		=> '',
    ...
    if( 1 != 1  && of_get_option('numsection', 7) > 0 ) {
                         	...
                         	<?php $k++; ?>
                                <div class="news-box <?php if($k%4==0){?>last<?php } ?>">
									<div class="news">
										...
										<div style="float:right;color:#cccccc;font-weight:bold;font-size:15px">
											<img style="width:auto;float:left;position:relative;top:3px;" src="<?php echo get_template_directory_uri(); ?>/images/icon-comment.png" />&nbsp;&nbsp;
											<?php echo get_comments_number(); ?></div><div class="clear">
										</div>
                						<?php the_excerpt(); ?>
            						</div>
                				</div>
                			<?php if($k%4==0){ ?><div class="clear"></div><?php } ?>
            			<?php endwhile; ?>
