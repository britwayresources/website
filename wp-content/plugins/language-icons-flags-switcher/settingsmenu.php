...
<DIV STYLE = "WIDTH:50%;float:left;">
			...
			<input type="checkbox" name="option_63" value="1" <?php checked( '1', get_option( 'option_63' ) ); ?>><img src="<?php echo plugins_url( 'img/Azerbaijan.png' , __FILE__ ); ?>" ><input type="url" placeholder="Enter a valid url address" name="option_name63" value="<?php echo get_option('option_name63'); ?>"><input type="number" value="<?php if(trim(get_option('option_order63'))==''){echo "0";}else{echo get_option('option_order63');}?>"  name="option_order63"><br/>
			
			<input type="checkbox" name="option_28" value="1" <?php checked( '1', get_option( 'option_28' ) ); ?>><img src="<?php echo plugins_url( 'img/argentina.png' , __FILE__ ); ?>" ><input type="url" placeholder="Enter a valid url address" name="option_name28" value="<?php echo get_option('option_name28'); ?>"><input type="number" value="<?php if(trim(get_option('option_order28'))==''){echo "0";}else{echo get_option('option_order28');}?>"  name="option_order28"><br/>
			
			<input type="checkbox" name="option_64" value="1" <?php checked( '1', get_option( 'option_64' ) ); ?>><img src="<?php echo plugins_url( 'img/Belarus.png' , __FILE__ ); ?>" ><input type="url" placeholder="Enter a valid url address" name="option_name64" value="<?php echo get_option('option_name64'); ?>"><input type="number" value="<?php if(trim(get_option('option_order64'))==''){echo "0";}else{echo get_option('option_order64');}?>"  name="option_order64" ><br/>
			...
			<input type="checkbox" name="option_65" value="1" <?php checked( '1', get_option( 'option_65' ) ); ?>><img src="<?php echo plugins_url( 'img/Cambodia.png' , __FILE__ ); ?>" ><input type="url" placeholder="Enter a valid url address" name="option_name65" value="<?php echo get_option('option_name65'); ?>"><input type="number" value="<?php if(trim(get_option('option_order65'))==''){echo "0";}else{echo get_option('option_order65');}?>"  name="option_order65"><br/>
			...
			<input type="checkbox" name="option_66" value="1" <?php checked( '1', get_option( 'option_66' ) ); ?>><img src="<?php echo plugins_url( 'img/Ethiopia.png' , __FILE__ ); ?>" ><input type="url" placeholder="Enter a valid url address" name="option_name66" value="<?php echo get_option('option_name66'); ?>"><input type="number" value="<?php if(trim(get_option('option_order66'))==''){echo "0";}else{echo get_option('option_order66');}?>"  name="option_order66"><br/>
...
<input type="checkbox" name="option_47" value="1" <?php checked( '1', get_option( 'option_47' ) ); ?>><img src="<?php echo plugins_url( 'img/klingon.png' , __FILE__ ); ?>" ><input type="url" placeholder="Enter a valid url address" name="option_name47" value="<?php echo get_option('option_name47'); ?>"><input type="number" value="<?php if(trim(get_option('option_order47'))==''){echo "0";}else{echo get_option('option_order47');}?>"  name="option_order47"><br/>
	...
	<input type="checkbox" name="option_67" value="1" <?php checked( '1', get_option( 'option_67' ) ); ?>><img src="<?php echo plugins_url( 'img/Libya.png' , __FILE__ ); ?>" ><input type="url" placeholder="Enter a valid url address" name="option_name67" value="<?php echo get_option('option_name67'); ?>"><input type="number" value="<?php if(trim(get_option('option_order67'))==''){echo "0";}else{echo get_option('option_order67');}?>"  name="option_order67"><br/>
	
		<input type="checkbox" name="option_68" value="1" <?php checked( '1', get_option( 'option_68' ) ); ?>><img src="<?php echo plugins_url( 'img/Luxembourg.png' , __FILE__ ); ?>" ><input type="url" placeholder="Enter a valid url address" name="option_name68" value="<?php echo get_option('option_name68'); ?>"><input type="number" value="<?php if(trim(get_option('option_order68'))==''){echo "0";}else{echo get_option('option_order68');}?>"  name="option_order68"><br/>
			...
			<input type="checkbox" name="option_70" value="1" <?php checked( '1', get_option( 'option_70' ) ); ?>><img src="<?php echo plugins_url( 'img/Morocco.png' , __FILE__ ); ?>" ><input type="url" placeholder="Enter a valid url address" name="option_name70" value="<?php echo get_option('option_name70'); ?>"><input type="number" value="<?php if(trim(get_option('option_order70'))==''){echo "0";}else{echo get_option('option_order70');}?>"  name="option_order70"><br/>
			...
			<input type="checkbox" name="option_21" value="1" <?php checked( '1', get_option( 'option_21' ) ); ?>><img src="<?php echo plugins_url( 'img/malaysia.png' , __FILE__ ); ?>" ><input type="url" placeholder="Enter a valid url address" name="option_name21" value="<?php echo get_option('option_name21'); ?>"><input type="number" value="<?php if(trim(get_option('option_order21'))==''){echo "0";}else{echo get_option('option_order21');}?>"  name="option_order21"><br/>
				...
				<input type="checkbox" name="option_69" value="1" <?php checked( '1', get_option( 'option_69' ) ); ?>><img src="<?php echo plugins_url( 'img/Mexico.png' , __FILE__ ); ?>" ><input type="url" placeholder="Enter a valid url address" name="option_name69" value="<?php echo get_option('option_name69'); ?>"><input type="number" value="<?php if(trim(get_option('option_order69'))==''){echo "0";}else{echo get_option('option_order69');}?>"  name="option_order69"><br/>
		...
		<input type="checkbox" name="option_74" value="1" <?php checked( '1', get_option( 'option_74' ) ); ?>><img src="<?php echo plugins_url( 'img/mongolia.png' , __FILE__ ); ?>" ><input type="url" placeholder="Enter a valid url address" name="option_name74" value="<?php echo get_option('option_name74'); ?>"><input type="number" value="<?php if(trim(get_option('option_order74'))==''){echo "0";}else{echo get_option('option_order74');}?>"  name="option_order74"><br/>
			...
			<input type="checkbox" name="option_26" value="1" <?php checked( '1', get_option( 'option_26' ) ); ?>><img src="<?php echo plugins_url( 'img/norway.png' , __FILE__ ); ?>" ><input type="url" placeholder="Enter a valid url address" name="option_name26" value="<?php echo get_option('option_name26'); ?>"><input type="number" value="<?php if(trim(get_option('option_order26'))==''){echo "0";}else{echo get_option('option_order26');}?>"  name="option_order26"><br/>
							...
							<input type="checkbox" name="option_71" value="1" <?php checked( '1', get_option( 'option_71' ) ); ?>><img src="<?php echo plugins_url( 'img/Palestine.png' , __FILE__ ); ?>" ><input type="url" placeholder="Enter a valid url address" name="option_name71" value="<?php echo get_option('option_name71'); ?>"><input type="number" value="<?php if(trim(get_option('option_order71'))==''){echo "0";}else{echo get_option('option_order71');}?>"  name="option_order71"><br/>
...
<input type="checkbox" name="option_45" value="1" <?php checked( '1', get_option( 'option_45' ) ); ?>><img src="<?php echo plugins_url( 'img/slovenia.png' , __FILE__ ); ?>" ><input type="url" placeholder="Enter a valid url address" name="option_name45" value="<?php echo get_option('option_name34'); ?>"><input type="number" value="<?php if(trim(get_option('option_order45'))==''){echo "0";}else{echo get_option('option_order45');}?>"  name="option_order45"><br/>
			...
			<input type="checkbox" name="option_61" value="1" <?php checked( '1', get_option( 'option_61' ) ); ?>><img src="<?php echo plugins_url( 'img/switzerland.png' , __FILE__ ); ?>" ><input type="url" placeholder="Enter a valid url address" name="option_name61" value="<?php echo get_option('option_name61'); ?>"><input type="number" value="<?php if(trim(get_option('option_order61'))==''){echo "0";}else{echo get_option('option_order61');}?>"  name="option_order61"><br/>
				...
				<input type="checkbox" name="option_72" value="1" <?php checked( '1', get_option( 'option_72' ) ); ?>><img src="<?php echo plugins_url( 'img/Taiwan.png' , __FILE__ ); ?>" ><input type="url" placeholder="Enter a valid url address" name="option_name72" value="<?php echo get_option('option_name72'); ?>"><input type="number" value="<?php if(trim(get_option('option_order72'))==''){echo "0";}else{echo get_option('option_order72');}?>"  name="option_order72" ><br/>
			...
			<input type="checkbox" name="option_73" value="1" <?php checked( '1', get_option( 'option_73' ) ); ?>><img src="<?php echo plugins_url( 'img/Vietnam.png' , __FILE__ ); ?>" ><input type="url" placeholder="Enter a valid url address" name="option_name73" value="<?php echo get_option('option_name73'); ?>"><input type="number" value="<?php if(trim(get_option('option_order73'))==''){echo "0";}else{echo get_option('option_order73');}?>"  name="option_order73"><br/>
